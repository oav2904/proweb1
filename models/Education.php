...
class Education
{
    ...
    public function create($egree, $timeperiod, $description, $website, $id_user)
    {
    ...
    public function update($id,$egree, $timeperiod, $description, $website, $id_user)
    {
        $this->connection->runStatement('UPDATE education 
    SET $egree=$2, $timeperiod=$3, $description=$4, $website=$5, $id_user=$6
    WHERE id=$1', [$id,$egree, $timeperiod, $description, $website, $id_user]);
    }
